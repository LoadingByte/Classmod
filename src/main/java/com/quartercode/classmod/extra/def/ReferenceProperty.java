...
public class ReferenceProperty<T> extends AbstractProperty<T> {
    ...
    /**
     * Creates a new {@link PropertyDefinition} that describes a reference property with the given name and ignore equals state.
     * 
     * @param name The name of the reference property which the returned {@link PropertyDefinition} describes.
    ...
    /**
     * Creates a new {@link PropertyDefinition} that describes a reference property with the given name, initial value and ignore equals state.
     * 
     * @param name The name of the reference property which the returned {@link PropertyDefinition} describes.
     * @param initialValue The initial value of the reference property which the returned {@link PropertyDefinition} describes.
     * @param cloneInitialValue Whether the initial value should be cloned for every new instance of the property (mostly {@code true}).
