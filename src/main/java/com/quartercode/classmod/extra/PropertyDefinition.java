 ...
 * The property definition also stores the {@link FunctionExecutor}s which are used for the {@link Property}'s getters and setters.<br>
 * <br>
...
public interface PropertyDefinition<T> extends FeatureDefinition<Property<T>> {
     ...
     * 
     * @param name The name of the getter {@link FunctionExecutor} to register. You can use that name to unregister the getter {@link FunctionExecutor} through {@link #removeGetterExecutor(String)}.
     ...
     * 
     * @param name The name of the setter {@link FunctionExecutor} to register. You can use that name to unregister the setter {@link FunctionExecutor} through {@link #removeSetterExecutor(String)}.
